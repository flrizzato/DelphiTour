...
type
  Tfrm_Main = class(TForm)
    ...
    ts_Discogs: TTabSheet;
    memo_Desc_FirstSteps: TMemo;
    edt_Discogs_BaseURL: TLabeledEdit;
    edt_Discogs_ResourcePath: TLabeledEdit;
    btn_Discogs: TButton;
    edt_Discogs_ArtistName: TLabeledEdit;
    ...
    procedure btn_DiscogsClick(Sender: TObject);
...
procedure Tfrm_Main.btn_DiscogsClick(Sender: TObject);
begin
  ResetRESTComponentsToDefaults;

  RESTClient.BaseURL := edt_Discogs_BaseURL.Text;
  RESTRequest.Resource := edt_Discogs_ResourcePath.Text;

  /// replace the placeholder "{NAME}" in the resource-uri with
  /// actual data from editfielsd "artistname".
  RESTRequest.Params.AddItem('NAME', edt_Discogs_ArtistName.Text, TRESTRequestParameterKind.pkURLSEGMENT);
...
begin
  ...
  OAuth1_Twitter.ConsumerSecrect := edt_Twitter_ConsumerSecret.Text;
...
begin
  ...
  pc_Demos.ActivePage := ts_Discogs;
