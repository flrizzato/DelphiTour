...
uses
  ...
  FMX.FlipView.Data, System.Actions, FMX.ActnList, FMX.StdCtrls;
...
procedure TFormMain.Init2;
  ...
  begin
    ...
    FEffectAni.AnimationType := TAnimationType.atOut;
    FEffectAni.Interpolation := TInterpolationType.itLinear;
...
procedure TFormMain.Init1;
  ...
  begin
    ...
    FTransitionAni.AnimationType := TAnimationType.atOut;
    FTransitionAni.Interpolation := TInterpolationType.itLinear;
