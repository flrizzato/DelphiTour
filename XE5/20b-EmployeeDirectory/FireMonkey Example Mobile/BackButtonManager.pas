...
uses FMX.TabControl, FMX.Types, System.Classes, FMX.Forms;
...
type
  ...
  private
  public
    class procedure HideBackActionControls(Root : TFMXObject);
...
class procedure TBackActionManager.HideBackActionControls(Root: TFMXObject);
var
  I : Integer;
  Comp : TFMXObject;
...
begin
  ...
  for I := 0 to Pred(Root.ChildrenCount) do begin
    ...
    TBackActionManager.HideBackActionControls(Comp);
  end;
end;
