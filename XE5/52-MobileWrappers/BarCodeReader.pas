...
// iOS part implemented by TMS software
// Android part implemented by Jim McKeeth
...
{$ENDIF}
  ...
  TZBarReaderGetResult = procedure(Sender: TBarCodeReader; ABarcode: string) of object;
