...
uses
  ...
  ToastMessage, FMX.Controls.Presentation, FMX.ScrollBox
{$IFDEF ANDROID}
...
type
  TMainForm = class(TForm)
    ...
    lstBarCode1: TListBoxItem;
    lstBarCode2: TListBoxItem;
    lstBarCode3: TListBoxItem;
    lstBarCode4: TListBoxItem;
    lstBarCode5: TListBoxItem;
    lstBarCode6: TListBoxItem;
    chkAttach: TCheckBox;
    Label4: TLabel;
