...
uses FMX.Helpers.Android, Androidapi.JNIBridge, Androidapi.JNI.JavaTypes,
...
procedure AndroidToast(const Msg: string; duration: TToastLength = ShortToast);
...
procedure AndroidToast(const Msg: string; duration: TToastLength);
var
  ToastLength: Integer;
begin
