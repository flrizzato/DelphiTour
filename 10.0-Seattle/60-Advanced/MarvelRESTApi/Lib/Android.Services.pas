    ...
    CallInUIThreadAndWaitFinishing(
      ...
      begin
        FDialog := TJProgressDialog.JavaClass.show(SharedActivity,
          StrToJCharSequence(FTitleText), StrToJCharSequence(FMessageText),
          False, False);
      end);
end;
...
TPlatformServices.Current.AddPlatformService(IIniFileService,
  TXplatIniFile.Create);
TPlatformServices.Current.AddPlatformService(IPleaseWaitService,
  TAndroidPleaseWait.Create);
