...
procedure TDebugDraw.ClearFlags(flags: LongWord);
begin
  FDrawWrapper.ClearFlags(flags);
end;

procedure TDebugDraw.AppendFlags(flags: LongWord);
begin
  FDrawWrapper.AppendFlags(flags);
end;

function TDebugDraw.GetFlags: LongWord;
begin
  Result := FDrawWrapper.GetFlags;
end;

procedure TDebugDraw.SetFlags(flags: LongWord);
begin
