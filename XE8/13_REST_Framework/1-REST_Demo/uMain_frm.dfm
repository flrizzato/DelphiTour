object frm_Main: Tfrm_Main
  ...
  object pc_Demos: TPageControl
    ...
    Width = 894
    Height = 365
    ActivePage = ts_GoogleTasks
    Align = alClient
    TabOrder = 1
    TabWidth = 95
    object ts_Discogs: TTabSheet
      Caption = 'Discogs'
      ImageIndex = 7
      ExplicitLeft = 0
      ExplicitTop = 0
      ExplicitWidth = 0
      ExplicitHeight = 0
      object memo_Desc_FirstSteps: TMemo
        ...
        Lines.Strings = (
          ...
          'service from Discogs.com and '
          'fetches some details about an artist'
          'from their music-library.'
          ''
          'no authentication is needed for'
          'basic queries like this.'
          ''
          'the resource-uri contains the place-'
          'holder "{NAME}" wich will be replaced'
          'with the value of the editfield'
          '"Artist-Name".')
        ReadOnly = True
        ScrollBars = ssVertical
        TabOrder = 0
      end
      object edt_Discogs_BaseURL: TLabeledEdit
        Left = 248
        Top = 32
        Width = 273
        Height = 21
        ...
        TabOrder = 1
        Text = 'http://api.discogs.com/'
      end
      object edt_Discogs_ResourcePath: TLabeledEdit
        Left = 248
        Top = 80
        Width = 273
        Height = 21
      ...
      object btn_Discogs: TButton
        Left = 248
        Top = 175
        Width = 273
        Height = 49
        Caption = 'fetch artist-details'
        TabOrder = 3
        OnClick = btn_DiscogsClick
      end
      object edt_Discogs_ArtistName: TLabeledEdit
        Left = 248
        Top = 132
        Width = 273
        Height = 21
