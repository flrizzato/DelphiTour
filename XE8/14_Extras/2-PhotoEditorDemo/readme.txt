...
IV. Supporting of different forms for iPhone and iPad

For form factor portability we can use form inheritance, creating one base form with common functionality for all forms and creating a form each
for iPhone (TPhoneMainForm) and iPad (TPadMainForm) inherited from TBaseMainForm.

For choosing the correct form, in the project file we can check which device is current, iPhone or iPad:
...
If the current device is iPhone, then we create instance of TPhoneMainForm, else TPadMainForm.

V. General way to apply effects on the received image
